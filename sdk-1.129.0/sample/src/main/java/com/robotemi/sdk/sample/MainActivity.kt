...
//        btnSetTts.setOnClickListener { setTts() }
        // new button
        btnAsrHello.setOnClickListener {
            onAsrResult("Hello")
        }
        btnGoAndRemind.setOnClickListener {
            // 2 possible solutions here
            // 1. Pass an Asr Result to invoke 2. write a private function to invoke
            goToPosition()
        }
    }
...
//        }
        if ("complete".equals(status) && "default".equals(state)) {
            robot.askQuestion("Hello, I'm Temi. Have you forgotten anything before leaving?")
        }
    }
    ...
    override fun onAsrResult(asrResult: String) {
        ...
        when {
            ...
            asrResult.lowercase().contains("follow me") -> {
                robot.speak(create("Okay, I'm coming.", true))
                robot.finishConversation()
                robot.beWithMe()
            }
